...
- `vga_matrix_text.vhd` — верхний модуль (top-level entity)
- `vga_matrix_text_tb.vhd` — тестбенч для ISim (Behavioral)
- `Basys2_100_250General.ucf` — ограничения пинов Basys 2
- `vga_matrix_text.xise` — файл проекта Xilinx ISE

> При создании нового проекта генератор автоматически заменяет `vga_matrix_text` на имя проекта,
